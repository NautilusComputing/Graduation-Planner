...
CREATE TABLE `users` (
  ...
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`major_id`) REFERENCES `majors` (`major_id`)
...
INSERT INTO `users` VALUES (1,'user1','password1','',1,3.00),(2,'user2','password2','',2,3.57),(3,'user3','password3','',1,2.43);
